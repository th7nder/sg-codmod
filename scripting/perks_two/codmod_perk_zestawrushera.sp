...
public Plugin myinfo = {
    name = "Call of Duty Mod - Perk - Zestaw Rushera",
    author = "th7nder",
...
char szClassName[] = {"Zestaw Rushera"};
char szDesc[] = {"Na początku rundy dostajesz Novę \n 1/12 na natychmiastowe zabójstwo. \n +25 kondycji"};
int g_iPerkId;
...
const WeaponID g_iGiveWeapon = WEAPON_NOVA;
char g_szGiveWeapon[] = "weapon_nova";
