...
public Plugin myinfo = {
    name = "Call of Duty Mod - Perk - Zmora Panth",
    author = "th7nder",
...
const WeaponID g_iGiveWeapon = WEAPON_SCAR20;
char g_szGiveWeapon[] = "weapon_scar20";
...
public void CodMod_OnPlayerDamaged(int iAttacker, int iVictim, float &fDamage, WeaponID iWeaponID, int iDamageType){
    if(g_bHasItem[iAttacker]){
        if(iWeaponID == g_iGiveWeapon && GetRandomInt(1, 11) == 1){
            fDamage *= 300.0;
        }
    }
}
