...
public Plugin myinfo = {
    name = "Call of Duty Mod - Perk - Złoty Deagle",
    author = "th7nder",
...
char szClassName[] = {"Złoty Deagle"};
char szDesc[] = {"Na początku rundy dostajesz Deagle'a \n Masz +25 zadawanych obrażeń z niego"};
int g_iPerkId;
