...
public Plugin myinfo = {
    name = "Call of Duty Mod - Perk - Pancerz Neomexowy",
    author = "th7nder",
...
char szClassName[] = {"Pancerz Neomexowy"};
char szDesc[] = {"Masz 1/10 na odbicie obrażeń."};
int g_iPerkId;
...
public void CodMod_OnPlayerDamagedPerk(int iAttacker, int iVictim, float &fDamage, WeaponID iWeaponID, int iDamageType){
    if(g_bHasItem[iVictim] && GetRandomInt(1, 100) >= 90){
