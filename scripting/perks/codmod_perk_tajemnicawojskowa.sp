...
public Plugin myinfo = {
    name = "Call of Duty Mod - Perk - Tajemnica Wojskowa",
    author = "th7nder",
...
char szClassName[] = {"Tajemnica Wojskowa"};
char szDesc[] = {"+40 wytrzymałości\n Masz  1/5 szans na oślepienie wroga"};
int g_iPerkId;
...
public void CodMod_OnPerkEnabled(int iClient, int iPerkId){
    ...
    CodMod_SetStat(iClient, ARMOR_PERK, CodMod_GetStat(iClient, ARMOR_PERK) + 40);
}
