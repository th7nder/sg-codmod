...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_slap", Command_Slap, ADMFLAG_GENERIC, "sm_slap <#userid|name> [damage]");
	RegAdminCmd("sm_slay", Command_Slay, ADMFLAG_GENERIC, "sm_slay <#userid|name>");
	RegAdminCmd("sm_rename", Command_Rename, ADMFLAG_GENERIC, "sm_rename <#userid|name>");
