...
public Plugin myinfo = {
    name = "Call of Duty Mod - Perk - Viva La France",
    author = "th7nder",
...
char szClassName[] = {"Viva La France"};
char szDesc[] = {"Na początku rundy dostajesz FAMASa \n +15 dmg z FAMASa"};
int g_iPerkId;
...
const WeaponID g_iGiveWeapon = WEAPON_FAMAS;
char g_szGiveWeapon[] = "weapon_famas";
