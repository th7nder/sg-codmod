...
public OnTouchedByEntity(const String:output[], caller, activator, Float:delay)
{
	...
	CodMod_DealDamage(owner, activator, float(damage), TH7_DMG_LASERMINE);
	//CodMod_PerformEntityExplosion(activator, owner, float(damage), 200, 0.0, TH7_DMG_LASERMINE);
	RemoveEdict(lasermine);
